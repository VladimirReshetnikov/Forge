"""Witness synthesis families merged from p1, p2, p4, p7 and p9.
  ...
  farkas      -- integer Farkas refutations of linear systems (Lean: Checker.Farkas)
...
"""
from . import affine, farkas, lattice, modular  # noqa: F401  (stdlib-only checkers)

__all__ = ['affine', 'farkas', 'lattice', 'modular', 'polynomial']
