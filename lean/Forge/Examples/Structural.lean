/-
  Merged from proposal p9-proof-planner, file lean/Structural.lean.

  List append/reverse/accumulator algebra. Chosen as the base of the five
  near-identical list files: the only Mathlib-free one, so it elaborates
  against core Lean alone.
