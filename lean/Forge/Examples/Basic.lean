/-
  Merged from proposal p9-proof-planner, file lean/CertificateExamples.lean.

  Three small certificate targets. Uses `nlinarith only [...]`, the tightest
  hypothesis discipline of the set.
