/-
  Merged from proposal p1-structural-search, file lean/StructuralReplay.lean.

  The cross-theory squeeze: p <= 0 plus sq_nonneg gives p = 0 gives congrArg f.
  The only genuine congruence-closure x arithmetic cooperation example.
