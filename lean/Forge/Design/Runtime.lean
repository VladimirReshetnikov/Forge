/-
  Merged from proposal p3-planner-certificate-layer, file lean/DesignAPI.lean.

  The proposed runtime/scheduler contract: obligations, candidates, scope keys,
  budgets, failure kinds, engine replies. Core Lean only.
