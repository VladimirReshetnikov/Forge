/-
  Merged from proposal p7-successor-architecture, file lean/GeneratedInduction.lean.

  Accumulator-invariant proofs, powers 0-8 plus two further shapes. Chosen over
  the power-sum-only variant, which is this file's a = 0 specialisation.
