...
| **Head-to-head, 20 HELD-OUT inequalities** (committed before any run) | `forge_cone?` **19**, `nlinarith` 3, `positivity` 0, `grind` 0, `omega` 0; 16 Forge-only, 0 Mathlib-only; the one miss (Choi–Lam) is not a sum of squares |
