...
Fourth, and the only new evidence: thirteen Lean files were compiled
(Tables~\ref{tab:lean} and~\ref{tab:lean-extensions}), and all nine extension
suites were re-run and reproduced their recorded counts
(Table~\ref{tab:extension-rerun}). Every one of the eighteen sources recorded
\code{NOT\_RUN} for Lean. That is now narrower --- three of the eighteen files
in the merged tree and ten of the twenty extension-round source files elaborate
under Lean v4.34.0, seven of the latter with no axiom dependencies at all ---
and the limits of what it shows are stated where the result appears.
