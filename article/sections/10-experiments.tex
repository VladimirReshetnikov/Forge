...
Three of the eighteen files in the merged tree import nothing beyond Lean core
...
about the other thirteen files in the merged tree, which import Mathlib and
need a built project, or about the two that merely import their siblings. It does not establish that any certificate checker is correct.
...
thirteen Lean artefacts --- three from the design round, ten from the extension
round --- type-check under the pinned toolchain, seven of them printing
\emph{does not depend on any axioms} for every theorem they expose.
