...
propositional fragment --- Dyckhoff's \textsf{LJT} being the standard choice ---
decides inhabitation rather than merely searching for it. Within its fragment,
exhaustion \emph{is} a proof of non-inhabitation, so it satisfies
Invariant~\ref{inv:negative} by construction, provided the translation into the
fragment records its own gaps in the ledger.
