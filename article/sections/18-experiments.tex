...
Twenty files therefore elaborate in total: six in the merged tree, ten in the
extension proposals, two of the third round's three and both of the fourth
round's two, with twelve of the twenty reporting no axiom dependencies. The merged \code{Indexing.lean} inherits \src{e8}'s scope note
