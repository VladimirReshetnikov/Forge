...
Aesop, \code{nlinarith}, LeanHammer, or any other tactic. Twenty-seven
...
Three of the twenty-seven files import nothing beyond Lean core and can
therefore be elaborated without a built Mathlib:
...
about the other twenty-four files, which import Mathlib and need a built project.
